...
-- Paste into the Supabase SQL editor, then add VITE_SUPABASE_URL and
-- VITE_SUPABASE_ANON_KEY to .env (Project Settings → API).
-- The access code is the shared secret. The anon key ships in the web app,
-- so do not store real patient PHI with this demo policy.
